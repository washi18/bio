...
public class ScannUtil {
	...
	public static String getPathCertificados(){
		return Executions.getCurrent().getDesktop().getWebApp().getRealPath(separator)+separator+"WEB-INF"+separator+"classes"+separator+"com"+separator+"bioandeanexpeditions"+separator+"resources"+separator;
	}
